...
public class WebSecurity extends WebSecurityConfigurerAdapter
{
    ...
    {
        http.cors().and().csrf().disable().authorizeRequests().antMatchers(HttpMethod.POST, SIGN_IN).permitAll().antMatchers(HttpMethod.POST, "/").permitAll().antMatchers(HttpMethod.GET, "/api/document/download").permitAll()
